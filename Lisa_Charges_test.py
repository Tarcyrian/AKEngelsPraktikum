...
def main():
    ...
    if char == "Ja":
        ...
        PDIRcharges = getchargesPDIR(geo_chargesPDIR, difb, lengthaPDIR)
    ...
    useroutput(char, DIP2, dup, dup2, verschiebung1, verschiebung2, xyz, shiftstart,
    ...
    if char == "Ja":
        ...
        outputchargesDIP(shiftchargexyz, step)
        ...
        outputeverythingDIPPDIR(first_input, file_geo2, DIPPDIR, first_charges,
    ...
    while i < shiftlength:
        ...
        if char == "Ja":
            ...
            outputeverythingDIPPDIR(new_input, file_geo2, DIPPDIR, new_charges,
                geo_chargesPDIR, step)
